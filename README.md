...
| Pasta | Descrição |
|-------|-----------|
| *(em breve)* | As implementações de exemplo serão organizadas aqui |

## Exemplos

Implementações práticas serão adicionadas progressivamente, cada uma com foco em uma funcionalidade ou caso de uso específico do framework. Cada exemplo terá seu próprio README com contexto, instruções de configuração e anotações sobre os resultados.
